// AES MMIO wrapper (word-oriented, 32-bit host)
// Offsets:
...
//  0x38 VERSION = 0x00010000
module aes_mmio (
    input  wire        clk,
    input  wire        rst_n,
    input  wire        wr,
    input  wire [5:0]  waddr,   // byte offset / word*4, use [5:2]
        ...
        if (!rst_n) begin
            ...
            if (wr) begin
                case (woff)
                    ...
                    4'h1: if (wdata[1]) done_sticky <= 1'b0; // W1C
